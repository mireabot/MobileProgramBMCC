...
<section style="margin-top: 50px">
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
        <div class="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
            <h1 class="titleText">Program <mark class="textFilled">events</mark></h1>
        </div>
        <div class="eventsGrid">
            ...
            $sql = "SELECT id, title, info, date, link FROM Events ORDER BY date DESC";
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo '<a href="' . $row["link"] . '"><img class="rounded-t-lg" src="BMCC_Logo.png" alt=""/></a>';
                    echo '<div class="p-5">';
                    echo '<h1 class="eventDateBadge">' . date('M d', strtotime($row["date"])) . '</h1>';
                    echo '<h5 class="eventTitle">' . $row["title"] . '</h5>';
                    echo '<p class="eventText">' . $row["info"] . '</p>';
                    echo '</div>';
                    echo '</div>';
                }
            } else {
        ...
        <div class="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
            <h1 class="titleText"><mark class="textFilled">Summer 2023</mark> workshop</h1>
        </div>
        <div class="eventsGrid">
            <div>
                <img class="eventImage" src="s1.png" alt="">
            </div>
            <div>
                <img class="eventImage" src="s2.png" alt="">
            </div>
            <div>
                <img class="eventImage" src="s3.png" alt="">
            </div>
            <div>
                <img class="eventImage" src="s4.png" alt="">
            </div>
            <div>
                <img class="eventImage" src="s5.png" alt="">
            </div>
            <div>
                <img class="eventImage" src="s6.png" alt="">
            </div>
            <div>
                <img class="eventImage" src="s7.png" alt="">
            </div>
        </div>
    </div>
</section>
